...
export const recommendedData = [
    { recommended: recommended.recommended1, title: 'Very Healthy', label: 'Very Healthy', price: '\u20A6 3000' },
    { recommended: recommended.recommended1, label: 'recommended1', price: '\u20A6 1500' },
    { recommended: recommended.recommended1, label: 'recommended1', price: '\u20A6 4000' },
];
  
export const fastSellingData = [
    { fastSelling: fastSelling.burger, 
        title: 'Burger', 
        price: '\u20A6 2500', 
        time: '10min away - 128 ordered' 
    },
    { fastSelling: fastSelling.whiteRice, 
        title: 'White-Rice',
        price: '\u20A6 7500', 
        time: '10min away - 128 ordered' },
