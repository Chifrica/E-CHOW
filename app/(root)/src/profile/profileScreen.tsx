    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.section}>
          ...
          />
          <Option
            icon={<FontAwesome name="heart-o" size={20} />}
            label="Favorites"
        ...
        <View style={styles.section}>
          ...
          />
          <Option
            icon={<Feather name="gift" size={20} />}
            label="Referrals"
          ...
          />
          <Option icon={<Feather name="star" size={20} />} label="Rate Us" />

          <Option
            icon={<Feather name="log-out" size={20} style={{ color: "red" }} />}
            label="Log Out"
            onPress={() =>
              Alert.alert(
                "Log Out",
