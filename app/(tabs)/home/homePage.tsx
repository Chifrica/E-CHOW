...
const HomePage = () => {
  ...
  useEffect(() => {
    if (!loading && user && !user.role) {
      // If user is logged in but has no role (profile incomplete/missing), redirect
        ...
        <View style={styles.header}>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <Feather name="chevron-down" size={16} color="#61605F" />
                </Text>
              </TouchableOpacity>
            </TouchableOpacity>
          </View>
          <View style={styles.miniHeader}>
            <TouchableOpacity style={styles.iconButton}>
              <Feather name="search" size={20} color="#61605F" />
            </TouchableOpacity>
            <TouchableOpacity
            ...
            >
              <Feather name="shopping-cart" size={20} color="#61605F" />
            </TouchableOpacity>
          </View>
        </View>
          ...
          >
            <View style={styles.categoryItem}>
              <View style={styles.categoryIconContainer}>
                <FontAwesome6 name="bowl-rice" size={16} color="#E58945" />
              </View>
              <Text style={styles.categoryLabel}>Rice</Text>
            </View>
            <View style={styles.categoryItem}>
              <View style={styles.categoryIconContainer}>
                <FontAwesome6 name="wine-bottle" size={16} color="#E58945" />
              </View>
            ...
            <View style={styles.categoryItem}>
              <View style={styles.categoryIconContainer}>
                <FontAwesome6 name="fish" size={16} color="#E58945" />
              </View>
            ...
            <View style={styles.categoryItem}>
              <View style={styles.categoryIconContainer}>
                <FontAwesome6 name="cookie-bite" size={16} color="#E58945" />
              </View>
            ...
            renderItem={({ item }) => (
              ...
              >
                ...
                <View style={styles.recommendedDetails}>
                  ...
                  <Text style={styles.recommendedRestaurant}>
                    {item.restaurant}
                  </Text>
        ...
        <View style={styles.sectionContainer}>
          ...
          <View style={styles.gridContainer}>
            {fastSellingData.slice(0, 6).map((item, index) => (
              ...
              >
                <Image source={item.fastSelling} style={styles.gridItemImage} />
              ...
              >
                ...
                <View style={styles.restaurantDetails}>
                  ...
                  <View style={styles.restaurantMeta}>
                    <Ionicons name="star" size={12} color="#E58945" />
