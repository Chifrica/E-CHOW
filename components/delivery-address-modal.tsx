...
const DeliveryAddressModal = ({ visible, onClose, onSelectAddress }: DeliveryAddressModalProps) => {
  ...
  const handleSelectAddress = (id: string) => {
    ...
    const selectedAddress = updatedAddresses.find((address) => address.isSelected)
    if (selectedAddress) {
      onSelectAddress({
      ...
      <SafeAreaView style={styles.centeredView}>
        <View style={styles.modalView}>
          ...
          <TouchableOpacity style={styles.addNewButton}>
            <Feather name="plus" size={20} color="#E58945" />
          ...
          {addresses.map((address) => (
            ...
            >
              <View style={styles.radioContainer}>
                <View style={[styles.radioOuter, address.isSelected && styles.radioOuterSelected]}>
